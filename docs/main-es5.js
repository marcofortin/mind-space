...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _today_today_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./today/today.component */
    "./src/app/today/today.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["DashboardComponent"], _today_today_component__WEBPACK_IMPORTED_MODULE_8__["TodayComponent"]],
  ...
  function srcAppDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function DashboardComponent(datePipe) {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function ngOnInit() {
          var updatedUrl = localStorage.getItem("photoUrl");

          if (updatedUrl) {
            // this.currentDate = this.datePipe.transform(new Date(), 'EEEE');
            this.currentDate = "Monday";
            if (this.currentDate == 'Monday') this.monUrl = updatedUrl;else if (this.currentDate == 'Tuesday') this.tueUrl = updatedUrl;else if (this.currentDate == 'Wednesday') this.wedUrl = updatedUrl;else if (this.currentDate == 'Thursday') this.thuUrl = updatedUrl;else this.friUrl = updatedUrl;
  ...
  /***/
  function srcAppTodayTodayComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppTodayTodayComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function TodayComponent(datePipe, router) {
        _classCallCheck(this, TodayComponent);

        this.datePipe = datePipe;
        this.router = router; // variable
    ...
    TodayComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/today/today.component.scss")).default]
    })], TodayComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/khazzamAir/Documents/GitHub/conuHacks/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
